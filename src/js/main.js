...
buildDOM: function(result) {
  ...
  getRequest: function() {
    ...
    let url = "https://api.nasa.gov/planetary/apod?api_key=N7uO3GEEOq1PeT6g2qtQ4MLqt2DhMvHhfdzQSEql&date=" + date;
    $.ajax({
        url: url
...
// btnRandApod event listener 
document.getElementById('btnRect').addEventListener('click', function(){
    apod.getRequest('#btnRandApod') background-color:red;
}, false);
